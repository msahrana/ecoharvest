        ...
        <div>
          ...
          <div className="flex flex-row gap-5 bg-white mb-6 rounded-md">
            ...
            <div className="flex flex-col justify-center space-y-3 text-center">
              <p className="flex gap-2 items-center text-sm md:text-xl">
                {" "}
          ...
          <button
            type="button"
            className="px-4 py-2 rounded-md bg-gradient-to-r from-green-300 to-[#50AD53] hover:from-pink-500 hover:to-orange-500 ..."
          >
            Support Us
          </button>
        </div>
